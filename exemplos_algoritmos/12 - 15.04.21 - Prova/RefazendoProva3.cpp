...
void adicionar(int *g, int *i, int *j, int *c, int *c2);
void mostrar(int *g, int *i, int *j, int *c, int *c2);
    ...
    while(menu != 0){
        ...
        switch(menu){
            ...
            case 1:
                ...
                (*contador)++;
                if(*contador - 1 < *n){
                    adicionar(gremio, inter, jogos, contador, contador2);
                } else {
            ...
            case 2:
                ...
                if(*leu == 0)
                    ...
                    mostrar(gremio, inter, jogos, contador, contador2);
                    cout << endl;
                }
                break;
            default:
...
void mostrar(int *g, int *i, int *j, int *c, int *c2){
    ...
    cout << "Número de grenais: " << *c - *c2 << endl << endl;
