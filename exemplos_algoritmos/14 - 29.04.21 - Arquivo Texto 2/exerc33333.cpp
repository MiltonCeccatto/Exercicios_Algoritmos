...
void venderProduto(estoque produto[], int *i);
...
int main() {
    ...
    do {
        ...
        cout << "5. Listar todos os produtos" << endl << endl;
...
void listar(estoque produto[], int *i, int *f) {
    ...
    *i = -1;
    ...
    if(ler.is_open()) {
        while(!ler.eof()) { /// Enquanto não chegou no fim da leitura
            (*i)++;
